...
public class VaultVoidGoal extends InVaultDiscoveryGoal<VaultVoidGoal> {

    /**
     * Constructor for HunterAbilityGoal.
     * @param targetProgress Target progress of the goal.
     */
    public VaultVoidGoal(float targetProgress)
    {
     ...
     */
    public VaultVoidGoal withPredicate(Predicate<VoidLiquidInsideEvent.Data> predicate)
    {
    ...
    {
        SkaiaCommonEvents.INSIDE_VOID_LIQUID.
                in(world).
     ...
     */
    protected List<Predicate<VoidLiquidInsideEvent.Data>> predicates = new LinkedList<>();
}
