...
import com.jwp.skaia_vh.events.PedestalInteractEvent;
...
public class VaultPedestalGoal extends InVaultDiscoveryGoal<VaultPedestalGoal> {

    /**
     * Constructor for HunterAbilityGoal.
     * @param targetProgress Target progress of the goal.
     */
    public VaultPedestalGoal(float targetProgress)
    {
     ...
     */
    public VaultPedestalGoal withPredicate(Predicate<PedestalInteractEvent.Data> predicate)
    {
    ...
    {
        SkaiaCommonEvents.INTERACT_PEDESTAL.
                in(world).
     ...
     */
    protected List<Predicate<PedestalInteractEvent.Data>> predicates = new LinkedList<>();
}
