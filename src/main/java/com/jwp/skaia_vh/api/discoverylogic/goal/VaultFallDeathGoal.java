...
import com.jwp.skaia_vh.events.FallDeathEvent;
...
public class VaultFallDeathGoal extends InVaultDiscoveryGoal<VaultFallDeathGoal> {

    /**
     * Constructor for HunterAbilityGoal.
     * @param targetProgress Target progress of the goal.
     */
    public VaultFallDeathGoal(float targetProgress)
    {
     ...
     */
    public VaultFallDeathGoal withPredicate(Predicate<FallDeathEvent.Data> predicate)
    {
    ...
    {
        SkaiaCommonEvents.FALL_TO_DEATH.
                in(world).
     ...
     */
    protected List<Predicate<FallDeathEvent.Data>> predicates = new LinkedList<>();
}
