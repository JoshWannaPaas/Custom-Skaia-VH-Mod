...
import com.jwp.skaia_vh.models.*;
...
//        REGISTRIES.associate( (Item) iskallia.vault.init.ModItems.FOCUS, ModDynamicModels.Focus.REGISTRY);
        ...
        REGISTRIES.associate( (Item) iskallia.vault.init.ModItems.FOCUS, Focus.REGISTRY);

        REGISTRIES.associate( (Item) iskallia.vault.init.ModItems.SHIELD, ModDynamicModels.Shields.REGISTRY);

        REGISTRIES.associate(iskallia.vault.init.ModItems.HELMET, ModDynamicModels.Armor.PIECE_REGISTRY.getPiecesOf(EquipmentSlot.HEAD)).associate(iskallia.vault.init.ModItems.CHESTPLATE, ModDynamicModels.Armor.PIECE_REGISTRY.getPiecesOf(EquipmentSlot.CHEST)).associate(iskallia.vault.init.ModItems.LEGGINGS, ModDynamicModels.Armor.PIECE_REGISTRY.getPiecesOf(EquipmentSlot.LEGS)).associate(iskallia.vault.init.ModItems.BOOTS, ModDynamicModels.Armor.PIECE_REGISTRY.getPiecesOf(EquipmentSlot.FEET)).associate(iskallia.vault.init.ModItems.IDOL_TIMEKEEPER, ModDynamicModels.Idols.REGISTRY_WENDARR).associate(iskallia.vault.init.ModItems.IDOL_MALEVOLENCE, ModDynamicModels.Idols.REGISTRY_IDONA).associate(iskallia.vault.init.ModItems.IDOL_BENEVOLENT, ModDynamicModels.Idols.REGISTRY_VELARA).associate(iskallia.vault.init.ModItems.IDOL_OMNISCIENT, ModDynamicModels.Idols.REGISTRY_TENOS).associate(iskallia.vault.init.ModItems.RELIC, ModDynamicModels.Relics.RELIC_REGISTRY).associate(iskallia.vault.init.ModItems.RELIC_FRAGMENT, ModDynamicModels.Relics.FRAGMENT_REGISTRY).associate(iskallia.vault.init.ModItems.ANTIQUE, ModDynamicModels.Antiques.REGISTRY);
    }
}
